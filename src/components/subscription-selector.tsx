...
const subscriptions: Subscription[] = [
  {
    ...
    logo: "logos:adobe",
    description: "Accédez à plus de 20 applications créatives Adobe, dont Photoshop, Illustrator et InDesign.",
    features: [
    ...
    durations: [
      ...
      { id: "adobe-annual", name: "Annuel", price: 479.88, regularPrice: 599.88 }
    ]
  },
  {
    id: "canva",
    ...
    durations: [
      ...
      { id: "canva-annual", name: "Annuel", price: 109.99, regularPrice: 143.88 }
    ]
  },
  {
    id: "figma",
...
export const SubscriptionSelector: React.FC<SubscriptionSelectorProps> = ({
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold mb-6">Choisissez votre abonnement</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {subscriptions.map((subscription) => (
          ...
          >
            ...
            <p className="text-sm text-default-500 mt-1 line-clamp-2">{subscription.description}</p>
          </div>
        ))}
      </div>
              ...
              >
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-lg font-semibold">{duration.price.toFixed(2)} €</span>
                    {duration.regularPrice && (
                      <span className="text-default-400 text-sm line-through">{duration.regularPrice.toFixed(2)} €</span>
                    )}
                    {duration.regularPrice && (
                      <span className="text-xs bg-success-100 text-success-600 px-1.5 py-0.5 rounded">
                        -{Math.round((1 - duration.price / duration.regularPrice) * 100)}%
                      </span>
                    )}
                  </div>
                </div>
