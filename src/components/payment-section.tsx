...
export const PaymentSection: React.FC<PaymentSectionProps> = ({
  ...
  const handlePayment = () => {
    ...
    setTimeout(() => {
      ...
      alert(
        "Paiement réussi! Vous recevrez un email avec les détails de votre abonnement."
      );
    }, 2000);
  };
  ...
  return (
    <div>
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4 text-xs text-default-500">
        <div className="flex items-center">
